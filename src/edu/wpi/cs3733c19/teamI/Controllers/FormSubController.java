            ...
            if(event.getSource()== submit_Button){
                ...
                if(readyToSend){
                    ...
                    */
                    ...
                    String [] columns = {"formID",  "repID",    "plantRegistry",    "domesticOrImported",   "serialNumber", "brandName",    "beverageType",     "fancifulName", "permitName",   "streetAddress",    "city",     "stateAbb",     "zipCode",  "mailingAddress",   "extraInfo",    "dateOfApplication",    "nameOfApplicant",  "formula",  "grapeVarietals",   "vintage",  "wineAppellation",  "email",    "phoneNumber",  "pHValue",  "alcoholContent",   "status",   "approvingUser",    "approvalDate",     "expirationDate",   "issuedDate",   "qualification",    "volume",   "receivedType",     "classTypeCode",    "originCode",   "permitID"};
                    String [] types =   {"real",    "text",     "text",             "text",                 "text",         "text",         "text",             "text",         "text",         "text",             "text",     "text",         "text",     "text",             "text",         "text",                 "text",             "text",     "text",             "text",     "text",             "text",     "text",         "real",     "real",             "text",     "text",             "text",             "text",             "text",         "text",             "text",     "text",             "text",             "text",         "text"};
                    ...
                    //TODO this section needs to be reformatted to have the right parts
