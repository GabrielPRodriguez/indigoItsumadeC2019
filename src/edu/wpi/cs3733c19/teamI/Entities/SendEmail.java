...
public class SendEmail {
    ...
    public void sendSimpleEmail(String toWho, String subject, String content){
        ...
        final String username = "ttbagentwpi@gmail.com";
        final String password = "ttbagentcs3733";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("ttbagentwpi@gmail.com"));
    ...
    public void senSimpleEmailTLS(){
        ...
        try {
            ...
            message.setFrom(new InternetAddress("ttbagentwpi@gmail.com"));
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("messi.g.r@gmail.com"));
